...
final class Version20251106175828 extends AbstractMigration
{
...
CREATE TABLE IF NOT EXISTS `request_limiter` (
  ...
  PRIMARY KEY (`id`)
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE `chat_boost_removed`');
        $this->addSql('DROP TABLE `chat_boost_updated`');
        $this->addSql('DROP TABLE `chat_join_request`');
        $this->addSql('DROP TABLE `chat_member_updated`');
        $this->addSql('DROP TABLE `poll_answer`');
        $this->addSql('DROP TABLE `poll`');
        $this->addSql('DROP TABLE `pre_checkout_query`');
        $this->addSql('DROP TABLE `shipping_query`');
        ...
        $this->addSql('DROP TABLE `message_reaction_count`');
